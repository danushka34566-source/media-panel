...
export default function ConfigToggle({
  ...
  return (
    <label className="grid min-h-16 cursor-pointer grid-cols-[minmax(0,1fr)_auto] items-center gap-x-4 py-3.5">
      ...
      <span className="flex shrink-0 items-center gap-2.5">
        <span className={clsx(
          'w-[4.75rem] text-right text-xs font-medium uppercase tracking-wide',
