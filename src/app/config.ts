...
import { getNavSortControlFromString, getSortByFromString } from '@/media/sort';
import { parseChromaCutoff, parseStartingHue } from '@/media/color/sort';
...
export const TEMPLATE_TITLE = 'Media Panel';
export const TEMPLATE_DESCRIPTION = 'Store photos and videos with EXIF metadata support.';
...
export const HAS_DRIVE_STORAGE_CLIENT =
  Boolean(process.env.DRIVE_STORAGE_BASE_URL) &&
  Boolean(process.env.NEXT_PUBLIC_DRIVE_STORAGE_PROJECT_ID) &&
  Boolean(process.env.NEXT_PUBLIC_DRIVE_STORAGE_BUCKET);
export const HAS_DRIVE_STORAGE =
  HAS_DRIVE_STORAGE_CLIENT &&
  Boolean(process.env.DRIVE_STORAGE_API_KEY);
...
export const BACKEND_ORCHESTRATOR_BASE_URL =
  process.env.BACKEND_ORCHESTRATOR_BASE_URL;
export const BACKEND_ORCHESTRATOR_SHARED_SECRET =
  process.env.BACKEND_ORCHESTRATOR_SHARED_SECRET;
export const BACKEND_ORCHESTRATOR_ENABLED = Boolean(
  BACKEND_ORCHESTRATOR_BASE_URL && BACKEND_ORCHESTRATOR_SHARED_SECRET,
);

// Video processing
// If '1', generate poster/preview during the initial Add step.
// Defaults to disabled to keep Vercel serverless actions fast and reliable.
export const TRANSCODE_VIDEOS_ON_ADD =
  process.env.NEXT_PUBLIC_TRANSCODE_VIDEOS_ON_ADD
    ? process.env.NEXT_PUBLIC_TRANSCODE_VIDEOS_ON_ADD === '1'
    : true;
// Generate full-length browser-playable streams (-stream.mp4/.webm)
// This can consume significant /tmp space on serverless platforms.
// Default OFF to avoid ENOSPC; enable explicitly when you have enough disk.
export const GENERATE_STREAM_DERIVATIVES =
  process.env.NEXT_PUBLIC_GENERATE_STREAM_DERIVATIVES === '1';
...
export const HIDE_TAGS_WITH_ONE_MEDIA =
  process.env.NEXT_PUBLIC_HIDE_TAGS_WITH_ONE_MEDIA === '1';
...
export const DEFAULT_THEME =
  process.env.NEXT_PUBLIC_DEFAULT_THEME === 'dark'
    ...
    : process.env.NEXT_PUBLIC_DEFAULT_THEME === 'light'
      ? 'light'
      : 'system';
export const MATTE_MEDIA =
  process.env.NEXT_PUBLIC_MATTE_MEDIA === '1';
...
export const APP_CONFIGURATION = {
  ...
  hasBackendOrchestrator: BACKEND_ORCHESTRATOR_ENABLED,
  backendOrchestratorBaseUrl: BACKEND_ORCHESTRATOR_BASE_URL,
  hasBackendProcessorSecret: Boolean(
  ...
  areMediaStaticallyOptimized: STATICALLY_OPTIMIZED_MEDIA,
  areMediaOGImagesStaticallyOptimized: STATICALLY_OPTIMIZED_MEDIA_OG_IMAGES,
  ...
  hideTagsWithOneMedia: HIDE_TAGS_WITH_ONE_MEDIA,
  // Sort
...
const ALL_DEPRECATED_ENV_VARS = [{
  ...
  replacement: 'NEXT_PUBLIC_STATICALLY_OPTIMIZE_MEDIA',
}, {
  old: 'NEXT_PUBLIC_STATICALLY_OPTIMIZE_OG_IMAGES',
  replacement: 'NEXT_PUBLIC_STATICALLY_OPTIMIZE_MEDIA_OG_IMAGES',
}, {
