...
export interface MediaSetCategory {
  recent?: boolean
  year?: string
  camera?: Camera
  lens?: Lens
...
export interface MediaSetCategories {
  recents: Recents
  years: Years
  cameras: Cameras
  lenses: Lenses
...
export interface MediaSetAttributes {
  photos: Media[]
  count?: number
...
const convertCategoryKeysToCategoryNames =
  (categoryKeys: CategoryKeys): (keyof MediaSetCategories)[] => {
