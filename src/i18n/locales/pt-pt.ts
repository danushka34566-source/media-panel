...
export const TEXT: I18N = {
  ...
  category: {
    ...
    tagPlural: 'Etiquetas',
    tagged: 'Etiquetado',
    taggedMedia: 'Fotografias etiquetadas',
  ...
  tooltip: {
    ...
    shareMedia: 'Partilhar Fotografia',
  ...
  auth: {
    ...
    signOut: 'Sair',
    email: 'Email ou nome de utilizador',
    password: 'Palavra-passe',
    invalidEmailPassword: 'Email/senha inválidos',
    verifyTitle: 'Confirme a sua identidade',
    verificationCode: 'Código de verificação',
    verifyCode: 'Verificar código',
    resendCode: 'Reenviar código',
    invalidVerificationCode: 'Esse código de verificação não é válido. Tente novamente.',
    enterAuthenticatorCode: 'Introduza o código de seis dígitos da sua aplicação autenticadora.',
    enterEmailCode: 'Introduza o código de seis dígitos enviado para o seu email.',
    enterSmsCode: 'Introduza o código de seis dígitos enviado para o seu telemóvel.',
    newEmailCodeSent: 'Foi enviado um novo código para o seu email.',
    newSmsCodeSent: 'Foi enviado um novo código para o seu telemóvel.',
    enterCurrentCode: 'Introduza o código atual para continuar.',
    createAccount: 'Criar conta',
    forgotPassword: 'Esqueceu-se da palavra-passe?',
  },
  admin: {
    uploadMedia: 'Enviar fotografias',
    upload: 'Enviar',
    uploadPlural: 'Envios',
    uploading: 'A enviar',
    update: 'Atualizar',
    updatePlural: 'Atualizações',
    manageMedia: 'Gerenciar fotografias',
    ...
    selectMedia: 'Selecionar Fotografias ...',
    selectMediaExit: 'Parar de Selecionar',
  ...
  onboarding: {
    ...
    setupFirstMedia: 'Adicione sua primeira fotografia',
