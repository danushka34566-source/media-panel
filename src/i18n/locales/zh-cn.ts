...
export const TEXT: I18N = {
  ...
  auth: {
    ...
    enterAuthenticatorCode: '请输入身份验证器应用中的六位代码。',
    enterEmailCode: '请输入发送到您邮箱的六位代码。',
    enterSmsCode: '请输入发送到您手机的六位代码。',
    newEmailCodeSent: '新验证码已发送到您的邮箱。',
    newSmsCodeSent: '新验证码已发送到您的手机。',
    enterCurrentCode: '请输入当前验证码以继续。',
    createAccount: '创建账户',
    forgotPassword: '忘记密码？',
  },
  admin: {
