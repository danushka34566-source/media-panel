...
export const MAX_MEDIA_TO_SHOW_OG = 12;
export const MAX_MEDIA_TO_SHOW_PER_CATEGORY = 6;
export const MAX_MEDIA_TO_SHOW_TEMPLATE = 16;
export const MAX_MEDIA_TO_SHOW_TEMPLATE_TIGHT = 12;
