...
type LensWithMediaId = Lens & { photoId: string };

export interface LensProps {
  params: Promise<Lens>
}

export interface LensMediaProps {
  params: Promise<LensWithMediaId>
}
...
export const getLensMediaFromParams = async (
  params: Promise<LensWithMediaId>,
): Promise<LensWithMediaId> => {
